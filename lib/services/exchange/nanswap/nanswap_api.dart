...
class NanswapAPI {
  ...
  @visibleForTesting
  NanswapAPI({HTTP? http}) : client = http ?? HTTP();

  static final NanswapAPI _instance = NanswapAPI();
  static NanswapAPI get instance => _instance;
  ...
  Future<ExchangeResponse<Decimal>> getMinimalExchangeAmount({
    ...
    Map<String, dynamic>? params = {"api_key": apiKey ?? kNanswapApiKey};
  ...
  Future<ExchangeResponse<CNExchangeEstimate>> getEstimatedExchangeAmountV2({
    ...
    try {
      // simple json object is expected here
      final json = await _makeGetRequestV2(uri, apiKey ?? kNanswapApiKey);
  ...
  Future<ExchangeResponse<List<FixedRateMarket>>> getAvailableFixedRateMarkets({
    ...
    final uri = _buildUri(
        "/market-info/fixed-rate/${apiKey ?? kNanswapApiKey}", null);
  ...
  Future<ExchangeResponse<ExchangeTransaction>>
    ...
    final uri = _buildUri("/transactions/${apiKey ?? kNanswapApiKey}", null);
  ...
  Future<ExchangeResponse<ExchangeTransaction>>
    ...
    final uri = _buildUri(
      "/transactions/fixed-rate${reversed ? "/from-result" : ""}/${apiKey ?? kNanswapApiKey}",
      null,
    );
  ...
  Future<ExchangeResponse<ExchangeTransactionStatus>> getTransactionStatus({
    ...
    final uri =
        _buildUri("/transactions/$id/${apiKey ?? kNanswapApiKey}", null);
